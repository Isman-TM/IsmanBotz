...
➣ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
                ...
                isman.sendMessage(m.chat, { image: { url: result }, caption: '➣ Media Url : '+result }, { quoted: fkntkman })
            }
            break
